...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $farmerQuery = "SELECT * FROM farmers WHERE email = '$email' AND password = '$password'";
    ...
    if ($farmerResult && $farmerResult->num_rows > 0) {
        ...
        // Redirect to the farmer's dashboard with a welcoming message
        header("Location: farmerdb.php?farmer_id=$farmerID");
        exit();
    }
...
<body>
    <div class="login-container">
        <h2>Welcome to the Dairy Farm System</h2>
        <p>Login as:</p>
